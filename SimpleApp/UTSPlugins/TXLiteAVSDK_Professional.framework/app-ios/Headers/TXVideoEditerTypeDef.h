 ...
 * 分屏合成使用的时长模式
 */
typedef NS_ENUM(NSInteger, TXDurationControlMode) {
  /// 对齐最长的视频
  ALIGNS_TO_LONGEST = 0,
  /// 对齐最短的视频
  ALIGNS_TO_SHORTEST = 1,
};

@interface TXSplitScreenParams : NSObject
...
@property(nonatomic, assign) TXDurationControlMode durationMode;
