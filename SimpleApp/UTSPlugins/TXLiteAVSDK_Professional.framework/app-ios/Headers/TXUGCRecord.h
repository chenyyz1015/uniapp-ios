 ...
 */
- (void)setVideoRenderMirrorType:(TXVideoRenderMirrorType)mirrorType;

/**
 * 设置视频编码镜像
 * @param isMirror 是否编码镜像
 */
- (void)setVideoEncoderMirror:(BOOL)isMirror;
...
/**
  ...
  @return 0 成功, -1 不存在录制任务, -2 videoRecorder未初始化
 */
- (int)pauseRecord:(nullable void (^)(void))complete;
